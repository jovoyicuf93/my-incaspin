...
function logDrop(mult){var chip=document.createElement("span");chip.className="drop-chip-5e786c19"+
...
function say(text,mood){noteEl.textContent=text;noteEl.classList.remove("drop-note-up","drop-note-down");if(mood==="up"){noteEl.classList.add("drop-note-up-5e786c19");}else if(mood==="down"){noteEl.classList.add("drop-note-down-5e786c19");}}
